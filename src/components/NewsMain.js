                            ...
                            <div className="col-sm-8">
                                {
                                    firstArticle.map((element, i) => {
                                        if (i === 0) {
                                            return (<NewsHeader item={0} key={element.url} title={element.title ? (element.title.length > 50 ? (element.title = element.title.slice(0, 50) + "...") : element.title) : ""} description={element.description ? (element.description.length > 100 ? (element.description = element.description.slice(0, 100) + "...") : element.description) : ""} imageUrl={element.urlToImage}
                                                newsUrl={element.url} publishedAt={element.publishedAt} author={(element.author ? element.author : "unknown")} source={element.source.name}></NewsHeader>
                                            )
                                        }
                                    })
                                    ...
                                    <div className="col">
                                        {
                                            firstArticle.map((element, i) => {
                                                if (i === 1) {
                                                    return (<NewsItem mainItem={true} key={element.url} title={element.title ? (element.title.length > 50 ? (element.title = element.title.slice(0, 50) + "...") : element.title) : ""} description={element.description ? (element.description.length > 100 ? (element.description = element.description.slice(0, 100) + "...") : element.description) : ""} imageUrl={element.urlToImage}
